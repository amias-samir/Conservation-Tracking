...
//    public static final String KEY_DEFAULT_USER_NAME = "naxa-admin";
//    public static final String KEY_DEFAULT_USER_PASS = "naxaadmin";

    public static final String KEY_DEFAULT_USER_NAME = "a";
    public static final String KEY_DEFAULT_USER_PASS = "a";
