 ...
 */
public class RevolvingFund extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    Toolbar toolbar;
    ...
    String projectCode, agreement_no, grantee_name, fiscal_year, district, vdc, bzuc_cfcc_name,
            ...
            soft_loan, total_cumulative_fund, others, areaha, area_gps;
    String plantationPolygonArea;
    JSONArray jsonArrayGPS = new JSONArray();
    TextView tvBoundryUsingGps;
    AutoCompleteTextView tvOtherGroups, tvOtherLandscape, tvFundingSource, tvProjectCode, tvAgreement_no, tvGrantew_name, tvFiscal_year, tvDistrictname, tvNameOfVdc,
            tvBzCorridorName, tvEstablishmentYear, tvTal, tvBzucCfugs, tvTotalFund, tvPersonHHSupt, tvNumber,
            tvSoftLoan, tvTotalCumulativeFund, tvOtherFundSupport, tvOthers;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvFundingSource = (AutoCompleteTextView) findViewById(R.id.cs_rf_detail_fundingSource);
        tvAgreement_no = (AutoCompleteTextView) findViewById(R.id.cs_rf_Agreement_No);
        tvGrantew_name = (AutoCompleteTextView) findViewById(R.id.cs_rf_Grantee_Name);
        tvFiscal_year = (AutoCompleteTextView) findViewById(R.id.cs_rf_fiscal_Year);
        tvDistrictname = (AutoCompleteTextView) findViewById(R.id.cs_rf_detail_DistrictName);
        tvNameOfVdc = (AutoCompleteTextView) findViewById(R.id.cs_rf_detail_Vdc_Municipality_Name);
        tvBzCorridorName = (AutoCompleteTextView) findViewById(R.id.cs_rf_bzcorridorName_Detail);
        tvEstablishmentYear = (AutoCompleteTextView) findViewById(R.id.cs_rf_establish_Year);
        tvTal = (AutoCompleteTextView) findViewById(R.id.cs_rf_tal);
        tvBzucCfugs = (AutoCompleteTextView) findViewById(R.id.cs_rf_detail_BZUC);
        tvTotalFund = (AutoCompleteTextView) findViewById(R.id.cs_rf_Detail_Totalfund);
        tvPersonHHSupt = (AutoCompleteTextView) findViewById(R.id.cs_rf_Person_hh_supported);
        spinnerTargetGrouup = (Spinner) findViewById(R.id.cs_rf_spinner_detail_TargetGroup);
        tvNumber = (AutoCompleteTextView) findViewById(R.id.cs_rf_Number);
        tvSoftLoan = (AutoCompleteTextView) findViewById(R.id.cs_rf_soft_loan);
        tvTotalCumulativeFund = (AutoCompleteTextView) findViewById(R.id.cs_rf_detail_total_C_fund);
        tvOtherFundSupport = (AutoCompleteTextView) findViewById(R.id.cs_rf_otherFund);
        tvOthers = (AutoCompleteTextView) findViewById(R.id.cs_rf_detail_notes);
        tvOtherGroups = (AutoCompleteTextView) findViewById(R.id.cs_rf_otherGroup);
        startGps = (Button) findViewById(R.id.cs_rf_GpsStart);

        send = (Button) findViewById(R.id.cs_rf_detail_send);
        save = (Button) findViewById(R.id.cs_rf_detail_save);
        previewMap = (Button) findViewById(R.id.cs_rf_preview_map);
        ...
        singleSpinnerAdpt = new ArrayAdapter<String>(this,
                android.R.layout.simple_spinner_item, Constants.CS_RF_TARGET_GROUP);
        singleSpinnerAdpt
                .setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
...
//                        });
                        ...
                        logIn.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                if (dateDataCollected == null || dateDataCollected.equals("") || formName == null || formName.equals("")) {
                                    ...
                                    String[] data = new String[]{"65", formName, dateDataCollected, jsonToSend, jsonLatLangArray,
        ...
        previewMap.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (CheckValues.isFromSavedFrom) {
                    ...
                    startActivity(new Intent(RevolvingFund.this, MapPointActivity.class));
                } else {
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
        ...
        if (spinnerId == R.id.cs_rf_detail_landscape) {
            switch (position) {
                case 0:
                    landscape = "TAL PABZ";
                    break;
        ...
        if (spinnerId == R.id.cs_rf_spinner_detail_TargetGroup) {
            switch (position) {
                case 0:
...
//        String movname=getIntent().getExtras().getString("Title");
        ...
        imageName = "Revolving_fund_" + timeInMillis + PhoneUtils.getFormatedId();
...
//    }
    public void initilizeUI() {
        ...
        if (intent.hasExtra("JSON1")) {
            ...
            Log.e("REVOLVINGFUND", "i-" + imageName);
...
//            }
            try {
                //new adjustment
                Log.e("revolving_fund", "" + jsonToParse);
            ...
            gps = new GPS_TRACKER_FOR_POINT(RevolvingFund.this);
            gps.canGetLocation();
...
//    }
    ...
    public void convertDataToJson() {
        ...
        try {
            post_dict.put("tablename", "tbl_revolving_fund");
            ...
            header.put("funding_tal", tal);
            header.put("funding_bzuc_cfugs", bzuc_cfugs);
    ...
    public void parseJson(String jsonToParse) throws JSONException {
        ...
        tal = jsonObj.getString("funding_tal");
        bzuc_cfugs = jsonObj.getString("funding_bzuc_cfugs");
        ...
        if (actions1[0].equals("NRM based") || actions1[0].equals("HWC affected")) {
            ...
            int singleSpinnerAdptPosition1 = singleSpinnerAdpt.getPosition(actions1[0]);
            spinnerTargetGrouup.setSelection(singleSpinnerAdptPosition1);
            tvOtherGroups.setVisibility(View.GONE);
        ...
        protected void onPostExecute(String result) {
            ...
            if (result != null) {
                ...
                if (dataSentStatus.equals("ok")) {
                    ...
                    String[] data = new String[]{"65", "Revolving Fund", dateString, jsonToSend, jsonLatLangArray,
                            "" + imageName, "Sent", "0"};
