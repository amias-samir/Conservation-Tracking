 ...
 */
public class RecyclerListAdapter7 extends RecyclerView.Adapter<RecyclerListAdapter7.ContactViewHolder> {

    private List<Single_String_Title> colorList;

    public RecyclerListAdapter7(List<Single_String_Title> cList) {
    ...
    public ContactViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View itemView = LayoutInflater.
                ...
                inflate(R.layout.card_view_single_item_wmt, viewGroup, false);
