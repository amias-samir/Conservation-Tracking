 ...
 */
public class RecyclerListAdapter4 extends RecyclerView.Adapter<RecyclerListAdapter4.ContactViewHolder> {

    private List<Single_String_Title> colorList;

    public RecyclerListAdapter4(List<Single_String_Title> cList) {
    ...
    public ContactViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View itemView = LayoutInflater.
                ...
                inflate(R.layout.card_view_single_item_cc, viewGroup, false);
