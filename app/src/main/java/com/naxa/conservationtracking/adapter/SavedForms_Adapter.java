 ...
 */
public class SavedForms_Adapter extends RecyclerView.Adapter<SavedForms_Adapter.ContactViewHolder> {

    private List<SavedFormParameters> colorList;

    public SavedForms_Adapter(List<SavedFormParameters> cList) {
