 ...
 */
public class RecyclerListAdapter5 extends RecyclerView.Adapter<RecyclerListAdapter5.ContactViewHolder> {

    private List<Single_String_Title> colorList;

    public RecyclerListAdapter5(List<Single_String_Title> cList) {
    ...
    public ContactViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View itemView = LayoutInflater.
                ...
                inflate(R.layout.card_view_single_item_cs, viewGroup, false);
