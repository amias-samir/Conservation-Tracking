 ...
 */
public class Multiple_Selection_Dialog {
    public static void multipleChoice_IllegalLogging(Context context, int title, String displayText) {
        DisplayMetrics metrics = context.getResources().getDisplayMetrics();
        int width = metrics.widthPixels;
        int height = metrics.heightPixels;

        final Dialog showDialog = new Dialog(context);
        showDialog.setContentView(R.layout.multiple_checkbox);
        ...
        btnOk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String to_return = "Truck- "+editText1.getText().toString()+", Tractor- "+editText2.getText().toString()
                        ...
                        ", Sickle- "+editText5.getText().toString() + ", Timber- "+editText6.getText().toString() + ", Gun- "+editText7.getText().toString();
