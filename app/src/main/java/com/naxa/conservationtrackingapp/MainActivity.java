...
import com.naxa.conservationtrackingapp.fragment_main.Fragment_Grid_Home;
...
//            Toast.makeText(getApplicationContext(),"clicked : "+position ,Toast.LENGTH_SHORT ).show();
        switch (position) {
            case 1:
                ...
                mFragment = new Fragment_Grid_Home();
            ...
            case 11:
                ...
                break;
            case 12:
                startActivity(new Intent(MainActivity.this, General_Form.class));
                title = getString(R.string.general_form);
                color = R.color.general_frorm;
                break;
            case 13:
                startActivity(new Intent(MainActivity.this, SavedFormsActivity.class));
