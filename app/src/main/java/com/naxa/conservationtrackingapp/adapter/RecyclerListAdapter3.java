 ...
 */
public class RecyclerListAdapter3 extends RecyclerView.Adapter<RecyclerListAdapter3.ContactViewHolder> {

    private List<Single_String_Title> colorList;

    public RecyclerListAdapter3(List<Single_String_Title> cList) {
    ...
    public ContactViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View itemView = LayoutInflater.
                ...
                inflate(R.layout.card_view_single_item_hwcm, viewGroup, false);
