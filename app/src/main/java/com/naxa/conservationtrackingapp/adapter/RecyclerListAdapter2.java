 ...
 */
public class RecyclerListAdapter2 extends RecyclerView.Adapter<RecyclerListAdapter2.ContactViewHolder> {

    private List<Single_String_Title> colorList;

    public RecyclerListAdapter2(List<Single_String_Title> cList) {
    ...
    public ContactViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View itemView = LayoutInflater.
                ...
                inflate(R.layout.card_view_single_item_wtc, viewGroup, false);
