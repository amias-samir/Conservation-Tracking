...
public class OptAnimationLoader {
    ...
    private static Animation createAnimationFromXml(Context c, XmlPullParser parser,
        ...
        while (((type = parser.next()) != XmlPullParser.END_TAG || parser.getDepth() > depth)
            ...
            } else if (name.equals("SweetAlert.Rotate3dAnimation")) {
                anim = new Rotate3dAnimation(c, attrs);
            } else if (name.equals("SweetAlert.SweetAlertDialog")) {
                anim = new Rotate3dAnimation(c, attrs);
            } else if (name.equals("SweetAlert.ProgressHelper")) {
                anim = new Rotate3dAnimation(c, attrs);
            } else if (name.equals("SweetAlert.ProgressWheel")) {
                anim = new Rotate3dAnimation(c, attrs);
            } else if (name.equals("SweetAlert.SuccessTickView")) {
                anim = new Rotate3dAnimation(c, attrs);
            } else {
                try {
